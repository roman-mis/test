    ...
    service.runPayroll=function(req) {
        return Q.Promise(function(resolve,reject){
            ...
            .then(function(system) {
                ...
                db.Payroll.findOne({ isCurrent: true, weekNo: weekNo },function(err,payroll) {

                    if(!err) {
                        
                        log.push('Current payroll retrived for week: ' + weekNo);
                       ...
                       workers.forEach(function(worker){
                           ...
                           db.User.findById(worker._id,function(err,_worker) {
                               ...
                               if(!err) {
                                   ...
                                   log.push('Worker retrieved: ' + _worker.firstName + ' ' + _worker.lastName);
                                           ...
                                           if(!err) {
                                               ...
                                               console.log('here');
                                                   ...
                                                   if(totalPay+totalHolidayPayTaken>actualNMW) {
                                                       ...
                                                       // First pass - YTD for the more complex codes, the whole calc for the simpler ones
                                                       switch(taxCode) {
                                                               case 'L':
                                                               case 'P':
                                                               case 'T':
                                                       ...
                                                       // Second pass - finish up for the more complex codes
                                                       switch(taxCode) {
                                                               case 'L':
                                                               case 'P':
                                                               case 'T':
                                                       ...
                                                       log.push('Gross timesheet value: ' + totalPay);
                                                       log.push('Holiday pay accrued: ' + totalHolidayPay);
                                                       log.push('Holiday pay taken: ' + totalHolidayPayTaken);
                                                       log.push('Margin: ' + margin);
                                                       log.push('Expenses: ' + totalExpenses);
                                                       log.push('Employers NI: ' + employersNI);
                                                       log.push('Employees NI: ' + employeesNI);
                                                       log.push('Income Tax: ' + taxInPeriod);
                                               ...
                                               console.log('Error retriving timesheets: ' + err);
                                           }
                                       });
                                   });
                                   ...
                                   console.log('Error retriving worker: ' + err);
                               }
                           });
                       });
                    }
                    else {
                        console.log('Error retriving Payroll: ' + err);
                    }
                });
