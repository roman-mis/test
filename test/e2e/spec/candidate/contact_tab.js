...
describe('Checking candidates contact tab', function () {
  ...
  it('Primary contact info data input', function () {
    ...
    inputs.get(0).clear().sendKeys('02023' + number);
    inputs.get(1).clear().sendKeys('07023' + number);        
    ...
    expect(labels.get(0).getText()).toBe('02023' + number);
    expect(labels.get(1).getText()).toBe('07023' + number);
